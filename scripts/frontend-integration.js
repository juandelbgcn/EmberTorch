 ...
 * This file demonstrates how to integrate Embertorch with a web frontend
 */

// For React/Vue/Angular applications
export class EmbertorchClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new EmbertorchClient(provider, contractAddress);
